<!DOCTYPE html>
    ...
    <head>
        <meta charset="UTF-8">
        <title>Express GitHub Stats Card</title>
        <style>
...
.task-list-item { list-style-type: none; } .task-list-item-checkbox { margin-left: -20px; vertical-align: middle; }
    ...
    <body class="vscode-body vscode-light">
        <h1 id="express-github-stats-card">Express GitHub Stats Card</h1>
<p>Pass in a minimum of your <a href="https://docs.github.com/en/free-pro-team@latest/github/authenticating-to-github/creating-a-personal-access-token">GitHub access token</a> and a <a href="https://docs.github.com/en/free-pro-team@latest/github/setting-up-and-managing-your-github-user-account/remembering-your-github-username-or-email">GitHub username</a> and get this:</p>
<p><img src="file:////Users/cristin/Sites/express-github-stats-card/github-stats-card-screenshot.png" alt="Widget Screenshot"></p>
<h2 id="installation">Installation</h2>
<pre><code class="language-bash"><div>npm install express-github-stats-card
</div></code></pre>
<h2 id="example-using-express">Example using Express:</h2>
<p>The Card function returns an HTML string you can append anywhere. The first argument is the GitHub username, the second is your GitHub access token, and the third is an optional <code>Boolean</code> for whether or not you want to style the card with the included theme. Defaults to <code>false</code>.</p>
<p>Below is code for a <code>server.js</code> file you can use as a guide for setting up this component in your own Express application.</p>
<pre><code class="language-js"><div><span class="hljs-comment">// /server.js (command to run: node server.js)</span>
<span class="hljs-keyword">const</span> express = <span class="hljs-built_in">require</span>(<span class="hljs-string">&#x27;express&#x27;</span>);
<span class="hljs-keyword">const</span> Card = <span class="hljs-built_in">require</span>(<span class="hljs-string">&#x27;./components/Card&#x27;</span>).Card;

<span class="hljs-keyword">const</span> app = express();

app.get(<span class="hljs-string">&#x27;/&#x27;</span>, <span class="hljs-keyword">async</span> (req, res) =&gt; {
  <span class="hljs-comment">// I used the dotenv npm package with a .env file containing GITHUB_ACCESS_TOKEN. </span>
  <span class="hljs-comment">// THE .env file is in my .gitignore and will not show up here</span>
  <span class="hljs-keyword">const</span> statsCard = <span class="hljs-keyword">await</span> Card(<span class="hljs-string">&#x27;cnocon&#x27;</span>, process.env.GITHUB_ACCESS_TOKEN, <span class="hljs-literal">true</span>);
  res.send(statsCard);
});
